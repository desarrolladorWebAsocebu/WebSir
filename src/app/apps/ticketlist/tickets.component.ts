...
export class TicketsComponent implements OnInit {
  ...
  editTicket: UntypedFormGroup = Object.create(null);
  ...
  constructor(private ticketService: TicketService, private fb: UntypedFormBuilder, private modalService: NgbModal, private datePipe: DatePipe) {
